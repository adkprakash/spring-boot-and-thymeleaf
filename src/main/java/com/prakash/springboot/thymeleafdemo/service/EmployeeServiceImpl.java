...
import com.prakash.springboot.thymeleafdemo.dao.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	@Override
	public List<Employee> searchBy(String theSearchName) {
		return employeeRepository.doMyCustomSearch(theSearchName);
	}
